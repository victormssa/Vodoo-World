    ...
    useEffect(() => {
      const fetchUser = async () => {
        ...
        try {
          ...
          const {  email, fullname, username } = response.data; // Supondo que os dados de email e nome estão na resposta do servidor
  ...
  return (
    <>
      <section className="max-w-4xl p-6 mx-auto bg-white rounded-md  dark:bg-[#313131]">
        ...
        <form>
        <div className=" relative  w-20 h-20 lg:w-24 lg:h-24 mt-10 ">
                  <img
