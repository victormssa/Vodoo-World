...
const LoginForm: React.FC = () => {
  return (
    <>
        <div className="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-[#3a3a3a]">
    <div className="flex justify-center mx-auto">
        <img className="w-auto h-20 dark:hidden block" src={logoWhite} alt="" />
        <img className="w-auto h-20 hidden dark:block" src={logoBlack} alt="" />
    </div>
