...
const LoginForm: React.FC = () => {
      ...
      useEffect(() => {
        ...
        if (savedCredentials) {
          try {
            ...
            setUsername(parsedCredentials.email);
      ...
      const login = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
          const response = await axios.post(
            "https://api-vodoo-world.vercel.app/auth",
            newItem
          );
  ...
  return (
    <>
      <form onSubmit={login} className="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-lg  dark:bg-[#3a3a3a]">
